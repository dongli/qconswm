...
\begin{align}
  ...
  \left(\frac{u \tan{\varphi}}{a} V\right)_{i+\frac{1}{2},j} & \approx \left\{
    \begin{array}{ll}
      \frac{1}{4 a} \left[ \left( u_{i+\frac{1}{2},j}^* + u_{i+\frac{1}{2},j+1}^* \right) \left( V_{i,j+\frac{1}{2}} + V_{i+1,j+\frac{1}{2}} \right) \right. \\
      \left. + \left( u_{i+\frac{1}{2},j}^* + u_{i+\frac{1}{2},j-1}^* \right) \left( V_{i,j-\frac{1}{2}} + V_{i+1,j-\frac{1}{2}} \right) \right] & j = [2, 3, \dots, N_\varphi - 1] \\
      0 & j = [1, N_\varphi]
    \end{array}
  \right. \\
...
\begin{align}
  ...
  \left(\frac{u \tan{\varphi}}{a} U\right)_{i,j+\frac{1}{2}} & \approx
    \begin{array}{ll}
      \frac{1}{4 a} \left[ \left( u_{i+\frac{1}{2},j}^* + u_{i+\frac{1}{2},j+1}^* \right) \left( U_{i+\frac{1}{2},j} + U_{i+\frac{1}{2},j+1} \right) \right. \\
      \left. + \left( u_{i-\frac{1}{2},j}^* + u_{i-\frac{1}{2},j+1}^* \right) \left( U_{i-\frac{1}{2},j} + U_{i-\frac{1}{2},j+1} \right) \right] & j = [1, 2, \dots, N_\varphi]
    \end{array} \\
